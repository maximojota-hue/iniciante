...
function hb_save_meta( $pid ) {
    ...
    $keys = ['hb_preco','hb_raridade','hb_conservacao','hb_decada','hb_marca','hb_origem','hb_acompanha','hb_wa_msg','hb_seo_desc','hb_palavras','hb_historia'];
    foreach ( $keys as $k ) {
...
function hb_register_meta_rest() {
    $meta_keys = [
        ...
        'hb_marca', 'hb_origem', 'hb_acompanha', 'hb_wa_msg',
...
function hb_seo_meta() {
    if ( is_singular() ) {
        ...
        if ( $keys ) echo '<meta name="keywords" content="' . esc_attr($keys) . '">' . "\n";
